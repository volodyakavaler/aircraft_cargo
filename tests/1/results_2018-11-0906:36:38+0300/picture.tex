...
\begin{document}\begin{tikzpicture}[line join=round, line cap=round,>=Triangle,
  ...
  \draw [axis] (0,0,0) -- (11.0,0,0) node (xaxis) [above] {$x$};
  \draw [axis] (0,0,0) -- (0,2.0,0) node (xaxis) [above] {$z$};
  \draw [axis] (0,0,0) -- (0,0,2.0) node (xaxis) [above] {$y$};
  \begin{colormixin}{85!white}\pic at (0,0,0) {cube={0.5 0.5 0.5 cyan!50!blue}};
\end{colormixin}
