...
\begin{document}\begin{tikzpicture}[line join=round, line cap=round,>=Triangle,
  ...
  \begin{colormixin}{85!white}\pic at (0,0,0) {cube={0.5 0.5 0.5 blue}};
\pic at (0,0.5,0) {cube={0.5 0.5 0.5 green!50!red}};
\pic at (0,1.0,0) {cube={0.5 0.5 0.5 yellow}};
\pic at (0,1.5,0) {cube={0.5 0.5 0.5 gray!50!red}};
\end{colormixin}
