...
\begin{document}\begin{tikzpicture}[line join=round, line cap=round,>=Triangle,
  ...
  \begin{colormixin}{85!white}\pic at (0,0,0) {cube={5.0 5.0 5.0 green}};
\pic at (0,5.0,0) {cube={5.0 5.0 5.0 yellow!50!blue}};
\pic at (5.0,0,0) {cube={5.0 5.0 5.0 blue!50!red}};
\pic at (5.0,5.0,0) {cube={5.0 5.0 5.0 magenta!50!red}};
\end{colormixin}
