...
\begin{document}\begin{tikzpicture}[line join=round, line cap=round,>=Triangle,
  ...
  \begin{colormixin}{85!white}\pic at (0,0,0) {cube={6.0 6.0 6.0 black!50!blue}};
\pic at (0,0,6.0) {cube={7.0 6.0 4.0 yellow!50!blue}};
\pic at (7.0,0,6.0) {cube={3.0 6.0 2.0 cyan!50!red}};
\end{colormixin}
